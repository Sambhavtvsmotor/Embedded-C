...
void bitwise(void){
	...
	printf("The BitWise AND results in %d\n",bitAND);
	printf("The BitWise OR results in %d\n",bitOR);
	printf("The BitWise NOT for num1 results in %d\n",bitNOTnum1);
	printf("The BitWise NOT for num2 results in %d\n",bitNOTnum2);
	printf("The BitWise XOR results in %d\n",bitXOR);
...
void setbits(void){
	...
	printf("The result after setting the 4th and 7th bit is %x",res);
}
...
void clearbits(void){
	...
	printf("The results after clearing the 6th, 5th and 4th bit is %x",res);
}
